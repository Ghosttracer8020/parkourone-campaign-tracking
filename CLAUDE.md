...
**Core Value:** Verlässlich und korrekt zählen, wie viele echte Probetraining-Buchungen aus jeder Kampagne entstehen (Conversion) — und diese Zahl der Kampagne/Landingpage zuordnen. Wenn alles andere wegfällt, muss die Conversion-Attribution stimmen.
